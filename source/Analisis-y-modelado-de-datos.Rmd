...
```{r Fig-11,echo=FALSE,fig.cap="Serie temporal de la variable `MinTemp` en la zona 1, según el valor de `Location` ", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-12,echo=FALSE,fig.cap="Serie temporal de la variable `MaxTemp` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-13,echo=FALSE,fig.cap="Serie temporal de la variable `Rainfall` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-14,echo=FALSE,fig.cap="Serie temporal de la variable `Humidity9am` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-15,echo=FALSE,fig.cap="Serie temporal de la variable `Humidity3pm` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-16,echo=FALSE,fig.cap="Serie temporal de la variable `Temp9am` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-17,echo=FALSE,fig.cap="Serie temporal de la variable `Temp3pm` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-18,echo=FALSE,fig.cap="Serie temporal de la variable `WindGustDir\\_x` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-19,echo=FALSE,fig.cap="Serie temporal de la variable `WindGustDir\\_y` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-20,echo=FALSE,fig.cap="Serie temporal de la variable `WindDir9am\\_x` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-21,echo=FALSE,fig.cap="Serie temporal de la variable `WindDir9am\\_y` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-22,echo=FALSE,fig.cap="Serie temporal de la variable `WindDir3pm\\_x` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
```{r Fig-23,echo=FALSE,fig.cap="Serie temporal de la variable `WindDir3pm\\_y` en la zona 1, según el valor de `Location`", message=FALSE,results='hide', out.height="40%",fig.align = 'center'}
...
summary(lm1 <- lm(RainTomorrow ~ ., data = select(zonas[[3]],-c("Date"))))
slm1 <- step(lm1)
summary(slm1)
slm1$anova
