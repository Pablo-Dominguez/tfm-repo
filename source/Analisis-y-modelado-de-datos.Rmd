...
Destacar que hemos importado las variables tipo *string* como *factor*. A continuación, pod
...
kbl_types01 <- db_types01 %>% kbl(., booktabs = T, caption = "Left") %>% kable_styling(latex_options = c("striped","HOLD_position")
                                                                          ) 

kbl_types02 <- db_types02 %>% kbl(., booktabs = T, caption = "Right") %>% kable_styling(latex_options = c("striped","HOLD_position")) 
