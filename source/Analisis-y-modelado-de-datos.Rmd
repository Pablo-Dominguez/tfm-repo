...
## Agrupación por zona climática {#ag-zona-climat}
...
#db_vars[,-c(2)] %>% kable(., booktabs = T,caption = "15 variables más importantes para cada zona según el AIC.",escape = FALSE) %>% kable_styling(latex_options = c("striped","hold_position","scale_down")) %>% row_spec(0,align = 'c')
